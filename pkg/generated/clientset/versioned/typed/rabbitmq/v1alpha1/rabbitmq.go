...
import (
	...
	scheme "github.com/cuijxin/rabbitmq-operator/pkg/generated/clientset/versioned/scheme"
...
func newRabbitmqs(c *RabbitmqV1alpha1Client, namespace string) *rabbitmqs {
	return &rabbitmqs{
		client: c.RESTClient(),
		ns:     namespace,
	}
