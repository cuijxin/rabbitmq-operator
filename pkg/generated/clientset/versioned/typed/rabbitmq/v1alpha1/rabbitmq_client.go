...
import (
	...
	"github.com/cuijxin/rabbitmq-operator/pkg/generated/clientset/versioned/scheme"
...
// RabbitmqV1alpha1Client is used to interact with features provided by the rabbitmq.xintelligent.com group.
type RabbitmqV1alpha1Client struct {
	restClient rest.Interface
}

func (c *RabbitmqV1alpha1Client) Rabbitmqs(namespace string) RabbitmqInterface {
